...
from eu import QuestionPaperGenerator
import re
...
class Login_Window:
    def __init__(self, root):
        ...
        try:
            im = Image.open('C://ISHITA/images/background.jpg')
        ...
        try:
            img1 = Image.open(r"C:\ISHITA\images\loginicon.png")
            ...
            messagebox.showerror("Error", f"Error loading login icon: {e}")
        ...
        img2=Image.open(r"C:\ISHITA\images\smimg.png")
        ...
        img3=Image.open(r"C:\ISHITA\images\lock.png")
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            self.new_window = Toplevel(self.root)
            self.app = QuestionPaperGenerator(self.new_window)
        else: 
...
class Register:
    def __init__(self,root):
        ...
        #================bg image========================
        im=Image.open('C://ISHITA/images/wp2.jpg')
        self.bg=ImageTk.PhotoImage(image=im)
        bg_lbl=tk.Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relwidth=1,relheight=1)

        im1=Image.open('C://ISHITA/images/mainphotos/sundarbilu.jpg')
        ...
        #==================     buttons      ================
        img=Image.open('C://ISHITA/images/samer.jpg')
        ...
        img1=Image.open('C://ISHITA/images/samel.jpg')
